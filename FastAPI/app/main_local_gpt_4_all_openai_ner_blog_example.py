...
# Definimos el endpoint POST para extraer entidades y grafo usando el modelo local
...
# --- OPENAI ENDPOINT ---
# Importamos el modelo OpenAI de LangChain
from langchain import OpenAI
# Inicializamos el modelo OpenAI con el modelo GPT-4
langchain_llm = OpenAI(model_name="gpt-4", temperature=0)

# Creamos la cadena LLMChain para OpenAI
ner_graph_openai_chain = LLMChain(
	llm=langchain_llm,
	prompt=ner_graph_prompt,
)

# Definimos el endpoint POST para extraer entidades y grafo usando OpenAI
