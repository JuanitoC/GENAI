# main.py
# Archivo principal de la app FastAPI para gestión de PDFs
...
# Importar los routers (en este caso, el de PDFs)
...
# Incluir el router de PDFs para exponer los endpoints relacionados
